...
# Definir diretórios
json_dir <- "C:/Users/reina/OneDrive/Área de Trabalho/Mestrado/Codigos/extraindo_musica/data/processed"
csv_path <- "C:/Users/reina/OneDrive/Área de Trabalho/Mestrado/Codigos/extraindo_musica/data/musicas_completas.csv"
